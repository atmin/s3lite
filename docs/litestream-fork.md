...
- s3lite `go.mod`:
  ...
  replace github.com/benbjohnson/litestream => github.com/atmin/litestream v0.5.15-s3lite.6
  ```

- The consumed ref is an **immutable tag** — `v0.5.15-s3lite.6` is upstream `v0.5.15`
