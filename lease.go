...
func (db *DB) rebuildLocalFromReplica(ctx context.Context) error {
	...
	if err := restoreDBFunc(ctx, db.cfg.replica(), db.cfg.BackupTo, tmp, db.logger, db.cfg.OnRestoreProgress); err != nil {
...
func (db *DB) restoreLocalFromReplica(ctx context.Context) error {
	...
	if err := restoreDBFunc(ctx, db.cfg.replica(), db.cfg.BackupTo, path, db.logger, db.cfg.OnRestoreProgress); err != nil {
